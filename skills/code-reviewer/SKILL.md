...
- `references/pre_pr_self_review.md` — Mechanical 5-phase pre-PR check (lint gate, SPDX, diff risks, test coverage, commit messages). Use when the user wants a "is this branch ready to PR?" sweep, not a full code review.
